...
- Gaussian Mechanism: Gaussian Mechanism privatizes a statistic by adding Gaussian noise. The definition is that: Let $f: \mathcal{X}^n \rightarrow \mathbb{R}^k$. The $\ell_2$-sensitivity of $f$ is
