...
2. The attacker samples a base instance from the base class and makes imperceptible changes to it to craft a poison instance.
    ...
    - The rightmost term causes the poison instance p to appear like a base class instance to a human labeler. Meanwhile, the first term causes the poison instance to move toward the target instance in feature space and get embedded in the target class distriution.
...
![Experiment 29](experiment_29.jpg)
